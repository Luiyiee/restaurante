				...
				<div class="table-responsive">
					<table id="example" class="table table-bordered">
						...
						<tbody>
							...
							$sql_query = "SELECT * FROM gdf where consolidado = 'Pendiente' and eliminado ='1' ";
							...
							?>
								<tr>
									...
									<td>
                                        ...
                                        <button class="btn btn-success glyphicon glyphicon-remove" onclick="preguntarSiNo('<?php echo $ver['id'] ?>')">
