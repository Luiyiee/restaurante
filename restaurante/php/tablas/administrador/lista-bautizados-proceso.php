...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header"><i class="fa fa-table"></i> Lista de bautizados en proceso</div>

			<div class="card-header">
				<?php
				$sql_bautizados_proceso = "SELECT * from gdf where bautizado = 'Proceso' ";
				$result_bautizados_proceso = mysqli_query($conexion, $sql_bautizados_proceso);
				$bautizados_proceso = mysqli_fetch_assoc($result_bautizados_proceso);
				if ($bautizados_proceso > 0) {
				?>
					<button class="btn btn-success glyphicon glyphicon-remove" onclick="actualizar()">
				...
				<div class="table-responsive">
					<table id="example" class="table table-bordered">
						...
						<tbody>
							...
							$sql_query = "SELECT * FROM gdf where bautizado= 'Proceso' and eliminado ='1' ";
