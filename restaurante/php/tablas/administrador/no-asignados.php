...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header"><i class="fa fa-table"></i> No asignados</div>
			...
			<?php
				...
				?>
					...
					<button class="btn btn-danger glyphicon glyphicon-remove" onclick="eliminar()">
						Eliminar registros
					</button>
				<?php }?>
			...
			<div class="card-body">
				<div class="table-responsive">
					<table id="example" class="table table-bordered">
						...
						<tbody>
							<?php
							$sql_query = "select * from registros where tribu = '' and eliminado = '1' ORDER by tribu ASC ";
							...
							?>
								<tr>
									...
									<td>
										<button class="btn btn-warning btn-small btnVer" data-id="<?php echo $ver['id']; ?>" data-nombres="<?php echo $ver['nombres']; ?>" data-apellidos="<?php echo $ver['apellidos']; ?>" data-edad="<?php echo $ver['edad']; ?>" data-email="<?php echo $ver['email']; ?>" data-telefono="<?php echo $ver['telefono']; ?>" data-fecha="<?php echo $ver['fecha']; ?>" data-tribu="<?php echo $ver['tribu']; ?>" data-toggle="modal" data-target="#modalVer">
			...
			<form method="POST" enctype="multipart/form-data">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="emailVer" name="email">
					</div>
