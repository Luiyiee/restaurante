				...
				<div class="card">
					<div class="card-header">
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalNuevo">
							<i class="fa fa-plus"></i> Nuevo GDF
						</button>
					</div>
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<?php
								$sql_query = "SELECT * FROM usuarios where nivel = 'Lider' and eliminado ='1' ";
								...
								?>
									<tr>
										...
										<td>
											...
											<!-- modalNuevo,modalVer, modalEdicion,modalEliminar -->
											<button class="btn btn-danger glyphicon glyphicon-remove" 
					onclick="preguntarSiNo('<?php echo $ver['id'] ?>')">
					<i class="fa fa-trash"></i>
					</button>
											<!-- <button class="btn btn-danger btn-small " data-toggle="modal" data-target="#modalEliminar"  onclick="agregaform('<php echo $datos ?>')">
												 <i class="fa fa-edit"></i> 
												<i class="fa fa-trash"></i>
											</button> -->
										</td>
						...
						<!-- unico div con table card y cardbody-->
					</div>
				</div>
				<!-- fin table -->
			...
			<form method="POST" enctype="multipart/form-data">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="text" name="usuario" placeholder="usuario" id="usuarioVer" class="form-control" required>
					</div>
					...
					<div class="form-group">
						...
						<input type="text" name="telefono_1" placeholder="telefono 1" id="telefonoVer_1" class="form-control">

					</div>

					<div class="form-group">
						<label for="telefono_2">Telefono 2</label>
						<input type="text" name="telefono_2" placeholder="telefono 2" id="telefonoVer_2" class="form-control">
					...
					<div class="form-group">
						...
						<input type="text" name="estado" placeholder="estado" id="estadoVer" class="form-control" required>

					</div>

					<div class="form-group">
						<label for="fecha_creacion">Fecha creado</label>
						<input type="text" name="fecha_creacion" placeholder="fecha_creacion" id="fecha_creacionVer" class="form-control" required>
					</div>
					<div class="form-group">
						<label for="fecha_editado">Fecha editado</label>
						<input type="text" name="fecha_editado" placeholder="fecha_editado" id="fecha_editadoVer" class="form-control" required>
					</div>
