				...
				<div class="table-responsive">
					<table id="example" class="table table-bordered">
						...
						<tbody>
							...
							$sql_query = "SELECT * FROM gdf where encuentro= 'Encuentro' and eliminado ='1' ";
							...
							?>
								<tr>
									...
									<td>
										<button class="btn btn-warning btn-small btnVer" data-id="<?php echo $ver['id']; ?>" data-nombres="<?php echo $ver['nombres']; ?>" data-apellidos="<?php echo $ver['apellidos']; ?>" data-edad="<?php echo $ver['edad']; ?>" data-telefono="<?php echo $ver['telefono']; ?>" data-sexo="<?php echo $ver['sexo']; ?>" data-fecha="<?php echo $ver['fecha']; ?>" data-encuentro="<?php echo $ver['encuentro']; ?>" data-usuario="<?php echo $ver['usuario']; ?>" data-toggle="modal" data-target="#modalVer">
