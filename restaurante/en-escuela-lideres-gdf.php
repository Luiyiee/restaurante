...
<body class="bg-theme bg-theme1">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="frmEscuelaLideres" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="nombres" id="nombres" class="form-control" onchange="traer(value)">
                                        <option value="">Seleccione un discipulo</option>
                                        <?php
                                        $iduser = $_SESSION['datos_login']['usuario'];

                                        $sql_traer = "SELECT * FROM gdf where encuentro= 'Si_E' and escuela_lideres='No_E' and usuario='$iduser' and eliminado ='1' ";
                                        $result_traer = mysqli_query($conexion, $sql_traer);
                                        while ($ver = mysqli_fetch_array($result_traer)) {
                                        ?>
                                            <option value=" <?php echo $ver['nombres'] ?> "><?php echo $ver['nombres'] ?></option>
                                        <?php } ?>
                                    </select>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!--  -->
                    <form id="frmEscuelaLideresU" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tabla').load('php/tablas/gdf/en-escuela-lideres-gdf.php');
            // $('#buscador').load('php/tablas/buscador.php');
        });
    </script>
    <script>
        function traer(value) {
            var nombres = $('#nombres').val();
            // console.log(value);
            $.ajax({
                url: 'php/crud/gdf/escuela-lideres/traer-discipulos.php',
                type: 'GET',
                data: {
                    nombres: nombres
                },
                success: function(datos) {
                    ...
                    // document.getElementById("apellidos").innerHTML = datos[1];
                    for (d in datos) {
                        console.log(datos[d]);
                        $('#apellidos').val(datos[d]);
                        // console.log(document.getElementById("apellidos").innerHTML = datos[d]);
                    }
                    // console.log(document.getElementById("apellidos").innerHTML = datos[2]);
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#btnAgregar').click(function() {
                ...
                var formData = new FormData(document.getElementById("frmEscuelaLideres"));

                $.ajax({
                    url: "php/crud/gdf/escuela-lideres/agregar.php",
                    type: "post",
                    dataType: "html",
                    data: formData,
                    cache: false,
    ...
    <script type="text/javascript">
        ...
        function actualizaDatos() {
            ...
            var formData = new FormData(document.getElementById("frmEscuelaLideresU"));
            $.ajax({
                type: "POST",
                url: "php/crud/gdf/escuela-lideres/modificar.php",
                dataType: "html",
                data: formData,
                cache: false,
                contentType: false,
        ...
        function eliminarDatos(id) {
            ...
            $.ajax({
                type: "POST",
                url: "php/crud/gdf/escuela-lideres/eliminar.php",
                data: cadena,
                success: function(r) {
                    if (r == 1) {
                        exito_eliminar();
