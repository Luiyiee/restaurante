...
<body class="bg-theme bg-theme1">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tabla').load('php/tablas/administrador/lista-bautizados-proceso.php');
...
<!-- Actualizar -->
    <script type="text/javascript">
          function actualizar(id) {
            alertify.confirm('Actualizar Datos', 'Todos los registros pasaran a un estado de bautizado',
                function() {
                    actualizarDatos(id)
                }
        ...
        function actualizarDatos(id) {
            ...
            $.ajax({
                type: "POST",
                url: "php/crud/administrador/bautizos/actualizar.php",
                data: cadena,
                success: function(r) {
                    if (r == 1) {
                        exito_actualizar();
    ...
    <script type="text/javascript">
        ...
        function eliminarDatos(id) {
            ...
            $.ajax({
                type: "POST",
                url: "php/crud/administrador/bautizos/eliminar.php",
                data: cadena,
                success: function(r) {
                    if (r == 1) {
                        exito_eliminar();
    ...
    <script>
        ...
        function exito_actualizar() {
            Lobibox.notify('success', {
                ...
                position: 'top right',
                msg: 'Registros actualizados con exito'
            });
        }

        //  Cancelar eliminar
        function cancelar_actualziar() {
        ...
        function error_eliminar() {
            Lobibox.notify('error', {
                ...
                continueDelayOnInactiveTab: false,
                position: 'top right',
                msg: 'Lo sentenimos no se pudo actualizar'
            });
        }
        // ------------------------------------
        // Eliminar
