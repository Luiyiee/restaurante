   ...
   <div class="modal fade" id="modalEdicion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!--  -->
                    <form id="frmBautizos" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="input-group mb-3">
                                    <select name="bautizado" id="bautizadou" class="form-control input-sm">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tabla').load('php/tablas/gdf/lista-no-bautizados-gdf.php');
...
<script type="text/javascript">
        ...
        function actualizaDatos() {
            ...
            var formData = new FormData(document.getElementById("frmBautizos"));
            $.ajax({
                type: "POST",
                url: "php/crud/gdf/bautizos/modificar.php",
                dataType: "html",
                data: formData,
                cache: false,
                contentType: false,
