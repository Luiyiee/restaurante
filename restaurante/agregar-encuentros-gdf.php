...
<head>
    ...
    <title>Agregar encunetros GDF</title>
    <!--favicon-->
...
<body class="bg-theme bg-theme1">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tabla').load('php/tablas/gdf/agregar-encuentros-gdf.php');
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#btnAgregar').click(function() {
                ...
                var formData = new FormData(document.getElementById("frmEncuentros"));

                $.ajax({
                    url: "php/crud/gdf/encuentros/agregar.php",
                    type: "post",
                    dataType: "html",
                    data: formData,
                    cache: false,
    ...
    <script type="text/javascript">
        ...
        function actualizaDatos() {
            ...
            var formData = new FormData(document.getElementById("frmEncuentrosU"));
            $.ajax({
                type: "POST",
                url: "php/crud/gdf/encuentros/modificar.php",
                dataType: "html",
                data: formData,
                cache: false,
                contentType: false,
        ...
        function eliminarDatos(id) {
            ...
            $.ajax({
                type: "POST",
                url: "php/crud/gdf/encuentros/eliminar.php",
                data: cadena,
                success: function(r) {
                    if (r == 1) {
                        exito_eliminar();
