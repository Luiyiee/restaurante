...
<head>
    ...
    <title>Lista no encunetros GDF</title>
    <!--favicon-->
...
<body class="bg-theme bg-theme1">
    ...
    <div id="wrapper">
        ...
        } else if($_SESSION['datos_login']['nivel'] == "GDF") {
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!--  -->
                    <form id="frmNoEncuentros" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tabla').load('php/tablas/gdf/lista-no-encuentros-gdf.php');
    ...
    <script type="text/javascript">
        ...
        function actualizaDatos() {
            ...
            var formData = new FormData(document.getElementById("frmNoEncuentros"));
            $.ajax({
                type: "POST",
