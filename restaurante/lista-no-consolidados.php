...
<head>
    ...
    <title>No consolidados GDF</title>
    <!--favicon-->
...
<body class="bg-theme bg-theme1">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tabla').load('php/tablas/administrador/lista-no-consolidados.php');
            // $('#buscador').load('php/tablas/buscador.php');
        });
    </script>
<script>
function preguntarSiNo(id) {
            alertify.confirm('Consolidado', '¿Este registro a sido consolidado?',
                function() {
                    actualizarConsolidacion(id)
                }
        ...
        function actualizarConsolidacion(id) {  

            cadena = "id=" + id;

            $.ajax({
                type: "POST",
                url: "php/crud/administrador/consolidaciones/actualizar.php",
                data: cadena,
                success: function(r) {
                    if (r == 1) {
                        exito_consolidar();
    ...
    <script>
        ...
        function error_consolidar() {
            Lobibox.notify('error', {
                ...
                continueDelayOnInactiveTab: false,
                position: 'top right',
                msg: 'Lo sentenimos no se pudo enviar la actualización'
            });
        }
    </script>
</body>
