...
<body class="bg-theme bg-theme1">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!--  -->
                    <form id="frmAsignados" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tabla').load('php/tablas/administrador/asignados.php');
    ...
    <script type="text/javascript">
        ...
        function actualizaDatos() {
            ...
            var formData = new FormData(document.getElementById("frmAsignados"));
            $.ajax({
                type: "POST",
                url: "php/crud/administrador/registro/asignados.php",
                dataType: "html",
                data: formData,
                cache: false,
                contentType: false,
